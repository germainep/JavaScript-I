...
const search = inventory.find(function(el) {
  return el.id === 33;
});
console.log(`Car 33 is a ${search.car_year} ${search.car_make} ${search.car_model}`);
